...
@app.command()
def export(
    cfg: Annotated[Path, typer.Option("--cfg", help="Configuration directory")] = Path("config"),
    ...
    """
    try:
        typer.echo(f"🚀 Starting EBIOS RM risk assessment...")
        ...
        typer.echo(f"✅ Risk assessment completed successfully!")
...
def validate(
    ...
    try:
        ...
        assets, threats, settings, risk_sources, objectives, stakeholders, measures = loader.load_all(cfg)
